...
public class Window extends javax.swing.JFrame {
    ...
    public Window() {
        initComponents();
        LectorInstrucciones = new LectorinstruccionesTortuga();
    }
    ...
    private void btnInstruccionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInstruccionesActionPerformed
        LinkedList<String> comando = new LinkedList<>();
        comando.add("fd 100");
        comando.add("fb 200");
        comando.add("fd 50");
        listaInstrucciones lista  = new listaInstrucciones(this, true, comando);
